(function () {
  ...
  const WRITING_STYLE_PRESETS = {
    mass_family: {
      ...
      heading: {
        section_title: 'judgement_heading',
      },
      note: {
        insight_box: 'gentle_note',
        warning_soft: 'gentle_note',
      },
    },
  };
  ...
  const BLOCK_STYLES = {
    paragraph: {
      lead: {
        ...
        span: 'visibility: visible; font-size: 15px; line-height: 1.75; color: rgba(0, 0, 0, 0.9); letter-spacing: 1px; font-weight: 500;',
      },
      body: {
        section: 'margin: 0 8px 24px 8px; visibility: visible;',
        p: 'margin: 0; visibility: visible;',
        span: 'visibility: visible; font-size: 15px; line-height: 1.75; color: rgba(0, 0, 0, 0.9); letter-spacing: 1px;',
      },
      analysis: {
        section: 'margin: 0 8px 24px 8px; visibility: visible;',
        p: 'margin: 0; visibility: visible;',
    ...
    heading: {
      section_title: {
        ...
        p: 'margin: 0; visibility: visible;',
        strong: 'font-size: 17px; line-height: 1.75; color: rgba(0, 0, 0, 0.9); font-weight: 600; letter-spacing: 1px; visibility: visible;',
      },
      section_title_strong: {
        badgeSection:
          'margin: 22px 8px 6px 8px; text-align: left; line-height: 1.4; visibility: visible;',
        badgeSpan: 'display: inline-block; font-size: 12px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; visibility: visible;',
        titleSection: 'margin: 0 8px 22px 8px; text-align: left; line-height: 1.6; visibility: visible;',
        titleSpan: 'font-size: 19px; font-weight: 700; color: rgba(0, 0, 0, 0.9); letter-spacing: 1px; visibility: visible;',
      },
      judgement_heading: {
    ...
    note: {
      insight_box: {
        ...
        p: 'margin: 0; visibility: visible;',
        span: 'visibility: visible; font-size: 13px; line-height: 1.85; color: #666666; letter-spacing: 0.6px;',
      },
      warning_soft: {
        section: 'margin: 10px 8px 22px 8px; padding-left: 10px; border-left: 1.5px solid #d7dde6; visibility: visible;',
        p: 'margin: 0; visibility: visible;',
    ...
    quote: {
      data_point: {
        ...
        p: 'margin: 0; visibility: visible;',
        span: 'visibility: visible; font-size: 15px; line-height: 1.75; color: rgba(0, 0, 0, 0.9); font-weight: 600; letter-spacing: 1px;',
      },
    },
    statement: {
      centered_statement: {
  ...
  function validatePayload(payload) {
    ...
    if (payload.writing_style && String(payload.writing_style).trim() !== 'mass_family') {
      throw new Error('当前 bridge 仅支持 mass_family 风格');
    }
  ...
  function createListItem(prefixText, itemText, itemIndex) {
    ...
    contentP.appendChild(
      createLeafSpan(
        itemText,
        'visibility: visible; color:rgba(0, 0, 0, 0.9); font-size:15px; line-height:1.75; letter-spacing:1px;',
      ),
    );
  ...
  function createNumberedListItem(prefixText, itemText, itemIndex, renderContext) {
    ...
    prefixP.appendChild(
      createLeafSpan(
        prefixText,
        `visibility: visible; color:${renderContext.theme.accentColor}; font-size:21px; line-height:1.1; font-weight:700; letter-spacing:0.02em;`,
      ),
    );
    prefix.appendChild(prefixP);
  ...
  async function insertBlocks(blocks, replace = true, includeImages = true, themeConfig = null, writingStyle = 'mass_family') {
    const editor = getContentEditor();
    if (!editor) throw new Error('未找到正文编辑器');
  ...
  window.__ruoruoWechatPublisherMassFamily__ = {
    isInstalled: true,
